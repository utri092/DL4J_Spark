...
public class BenchMarkInferenceDistributedHDFSTwelve {

    public static JavaSparkContext startSparkSession(){
        SparkConf conf = new SparkConf();
        conf.setAppName("DL4JInferenceDistributed");
    ...
    public static void main(String[] args) throws Exception {
        ...
        String datafilePath = "hdfs://afog-master:9000/part4-projects/resources/benchmarks/dataset-1_converted_12x_6.csv";
